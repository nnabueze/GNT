...
class AdminController extends Controller
{
	...
	public function dashboard()
	{
		...
		$collection_ts = Collection::where("mda_id",Auth::user()->mda_id)->limit(5)->orderBy('created_at', 'DESC')->get();
		...
		$collection_ts = Collection::limit(5)->orderBy('created_at', 'DESC')->get();
