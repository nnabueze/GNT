...
<div id="ribbon">
	...
	<!-- breadcrumb -->
	<ol class="breadcrumb">
		<li>Fundsweep</li><li>Beneficiaries</li>
	</ol>
	<!-- end breadcrumb -->
...
<div id="content">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
			...
			<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-md pull-right header-btn hidden-mobile"><i class="fa fa-circle-arrow-up fa-lg"></i><span class="glyphicon glyphicon-plus"></span> Beneficiary</a>
		</div>
	</div>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="login-form" method="POST" action="/beneficiaries" class="smart-form" >
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<fieldset>
					<input type="hidden" value="<?php echo Auth::user()->igr_id?>" name="igr_id">
							<section>
								<div class="row">
									<label class="label col col-2">MDA/LGA</label>
									<div class="col col-10">
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<select name="mda_id" class="form-control" id="lga">
							...
							<section>
								<div class="row">
									<label class="label col col-2">Account No</label>
									<div class="col col-10">
										<label class="input"> <i class="icon-append fa fa-user"></i>
...
<!-- 		<br />
		...
		<div class="row">
			<div class="col-md-12">
			<form method="get" action="/mda_pos" >
					...
					<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
							...
							<div>
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
										...
										<tbody>
										@if($beneficial)
											@foreach($beneficial as $beneficial)
											<tr>
	    ...
	    $('#datatable_tabletools').dataTable({
			...
			"oTableTools": {
				...
				"xls",
				{
					"sExtends": "pdf",
					"sTitle": "IGR_PDF",
					"sPdfMessage": "IGR PDF Export",
					"sPdfSize": "letter"
				},
				{
					"sExtends": "print",
					"sMessage": "Generated by IGR Admin <i>(press Esc to close)</i>"
				}
				],
				"sSwfPath": "{{ asset('template/js/plugin/datatables/swf/copy_csv_xls_pdf.swf')}}"
			},
			"autoWidth" : true,
			"preDrawCallback" : function() {
				// Initialize the responsive datatables helper once.
