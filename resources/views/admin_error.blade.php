...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('template/css/smartadmin-rtl.min.css')}}">
		...
		<link rel="apple-touch-icon" sizes="152x152" href="{{ asset('template/img/splash/touch-icon-ipad-retina.png')}}">
		...
		<link rel="apple-touch-startup-image" href="{{ asset('template/img/splash/ipad-landscape.png')}}" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
		<link rel="apple-touch-startup-image" href="{{ asset('template/img/splash/ipad-portrait.png')}}" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
		<link rel="apple-touch-startup-image" href="{{ asset('template/img/splash/iphone.png')}}" media="screen and (max-device-width: 320px)">
...
<!-- #BODY -->
	...
	<script src="{{ asset('template/js/plugin/fastclick/fastclick.min.js')}}"></script>
		...
		<script src="{{ asset('template/js/plugin/flot/jquery.flot.cust.min.js')}}"></script>
		<script src="{{ asset('template/js/plugin/flot/jquery.flot.resize.min.js')}}"></script>
		<script src="{{ asset('template/js/plugin/flot/jquery.flot.time.min.js')}}"></script>
		<script src="{{ asset('template/js/plugin/flot/jquery.flot.tooltip.min.js')}}"></script>
		
		<!-- Vector Maps Plugin: Vectormap engine, Vectormap language -->
		<script src="{{ asset('template/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
		<script src="{{ asset('template/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
