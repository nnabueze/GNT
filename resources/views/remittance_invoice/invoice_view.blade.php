...
<div id="ribbon">
	...
	<!-- breadcrumb -->
	<ol class="breadcrumb">
		<li>Invoice/Remittance</li><li>Invoice</li>
	</ol>
	<!-- end breadcrumb -->
...
<div id="content">
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<form method="post" action="/list_invoice">
							...
							<div>
								...
								<thead>
									<tr>
										...
										<th data-hide="phone,tablet">INVOICE STATUS</th>
									...
									@if($invoice)
										...
										<tr>
											<td>{{$invoice->invoice_key}}</td>
											<td>{{$invoice->name}} </td>
											<td>{{$invoice->email}} </td>
											<td>{{$invoice->payer_id}} </td>
											<td>{{$invoice->phone}} </td>
											<td>{{$invoice->amount}} </td>
											<td>{{$invoice->worker->worker_name}}</td>
											<td>{{$invoice->subhead->subhead_name}}</td>
											<td><span <?php echo ($invoice->invoice_status=="1")? 'class="label label-success"': 'class="label label-primary"' ?>>
