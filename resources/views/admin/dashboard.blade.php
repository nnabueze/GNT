				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
						<ul id="sparks" class="">
							...
							<li class="sparks-info">
								<h5> This Month<span class="txt-color-purple"><i class="fa fa-arrow-circle-up"></i>₦45,500</span></h5>
								<div class="sparkline txt-color-purple hidden-mobile hidden-md hidden-sm">
									110,150,300,130,400,240,220,310,220,300, 270, 210
								</div>
							</li>
							<li class="sparks-info">
								<h5> Last Month <span class="txt-color-greenDark"><i class="fa fa-shopping-cart"></i>₦24,047</span></h5>
											...
											<div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1">
												<div class="row no-space">
													...
													<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 show-stats">
														...
														<div class="row">
															<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> <span class="text"> Bauchi <span class="pull-right">₦500</span> </span>
																<div class="progress">
																	<div class="progress-bar bg-color-blueDark" style="width: 85%;"></div>
																</div> </div>
															<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> <span class="text"> Tafawa Balewa <span class="pull-right">₦440</span> </span>
																<div class="progress">
																	<div class="progress-bar bg-color-blue" style="width: 70%;"></div>
																</div> </div>
															<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> <span class="text"> Misau <span class="pull-right">₦77</span> </span>
																<div class="progress">
																	<div class="progress-bar bg-color-blue" style="width: 53%;"></div>
																</div> </div>
															<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12"> <span class="text"> Zaki <span class="pull-right">₦70</span> </span>
																<div class="progress">
